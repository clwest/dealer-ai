...
| 94 | `admin/lender-submissions/<int:pk>/` | `views_f_and_i.admin_lender_submission_update` | `admin-lender-submission-update` | — | `defer-candidate-O2` |
| 95 | `admin/stipulations/` | `views_f_and_i.admin_stipulation_create` | `admin-stipulation-create` | — | `defer-candidate-O2` |
| 96 | `admin/stipulations/<int:pk>/` | `views_f_and_i.admin_stipulation_update` | `admin-stipulation-update` | — | `defer-candidate-O2` |
| 97 | `admin/contracts/` | `views_f_and_i.admin_contract_create` | `admin-contract-create` | — | `defer-candidate-O2` |
| 98 | `admin/contracts/<int:pk>/` | `views_f_and_i.admin_contract_update` | `admin-contract-update` | — | `defer-candidate-O2` |
| 99 | `admin/back-end-products/` | `views_f_and_i.admin_back_end_product_create` | `admin-back-end-product-create` | — | `defer-candidate-O2` |
...
| 130 | `admin/bhph-notes/<int:pk>/payments/` | `views_bhph_payments.admin_bhph_payment_create` | `admin-bhph-payment-create` | bhphApi.ts:220 `createBhphPayment` | `covered` |
| 131 | `admin/bhph-notes/<int:pk>/payments/list/` | `views_bhph_payments.admin_bhph_payment_list` | `admin-bhph-payment-list` | bhphApi.ts:197 `listBhphPayments` | `covered` |
| 132 | `admin/bhph-notes/<int:pk>/promises/` | `views_bhph_promises.admin_bhph_promise_create` | `admin-bhph-promise-create` | bhphApi.ts:341 `recordPromiseToPay` | `covered` |
| 133 | `admin/bhph-notes/<int:pk>/promises/list/` | `views_bhph_promises.admin_bhph_promise_list` | `admin-bhph-promise-list` | bhphApi.ts:248 `listBhphPromises` | `covered` |
| 134 | `admin/bhph-promises/<int:pk>/mark-kept/` | `views_bhph_promises.admin_bhph_promise_mark_kept` | `admin-bhph-promise-mark-kept` | bhphApi.ts:360 `markPromiseKept` | `covered` |
| 135 | `admin/bhph-promises/<int:pk>/mark-broken/` | `views_bhph_promises.admin_bhph_promise_mark_broken` | `admin-bhph-promise-mark-broken` | bhphApi.ts:378 `markPromiseBroken` | `covered` |
| 136 | `admin/bhph-notes/<int:pk>/contacts/` | `views_collection_contacts.admin_collection_contact_create` | `admin-collection-contact-create` | bhphApi.ts:415 `logCollectionContact` | `covered` |
| 137 | `admin/bhph-notes/<int:pk>/contacts/list/` | `views_collection_contacts.admin_collection_contact_list` | `admin-collection-contact-list` | bhphApi.ts:278 `listCollectionContacts` | `covered` |
| 138 | `admin/bhph-notes/<int:pk>/repossessions/` | `views_repossessions.admin_repossession_create` | `admin-repossession-create` | bhphApi.ts:437 `initiateRepossession` | `covered` |
| 139 | `admin/bhph-notes/<int:pk>/repossessions/list/` | `views_repossessions.admin_repossession_list` | `admin-repossession-list` | bhphApi.ts:307 `listRepossessions` | `covered` |
| 140 | `admin/bhph-repossessions/<int:pk>/mark-recovered/` | `views_repossessions.admin_repossession_mark_recovered` | `admin-repossession-mark-recovered` | bhphApi.ts:456 `markRepossessionRecovered` | `covered` |
| 141 | `admin/bhph-repossessions/<int:pk>/mark-re-intaked/` | `views_repossessions.admin_repossession_mark_re_intaked` | `admin-repossession-mark-re-intaked` | bhphApi.ts:475 `markRepossessionReIntaked` | `covered` |
| 142 | `admin/bhph/analytics/summary/` | `views_bhph_analytics.admin_bhph_analytics_summary` | `admin-bhph-analytics-summary` | bhphApi.ts:83 `fetchBhphAnalyticsSummary` | `covered` |
| 143 | `admin/accounting/journal-entries/` | `views_accounting.admin_journal_entry_create` | `admin-journal-entry-create` | accountingApi.ts:383 `createJournalEntry` | `covered` |
| 144 | `admin/accounting/journal-entries/<int:pk>/reverse/` | `views_accounting.admin_journal_entry_reverse` | `admin-journal-entry-reverse` | accountingApi.ts:266 `reverseJournalEntry` | `covered` |
| 145 | `admin/accounting/journal-entries/<int:pk>/` | `views_accounting.admin_journal_entry_retrieve` | `admin-journal-entry-retrieve` | accountingApi.ts:242 `fetchJournalEntry` | `covered` |
| 146 | `admin/accounting/trial-balance/` | `views_accounting.admin_trial_balance` | `admin-trial-balance` | accountingApi.ts:71 `fetchTrialBalance` | `covered` |
| 147 | `admin/accounting/journal-entries/list/` | `views_accounting.admin_journal_entry_list` | `admin-journal-entry-list` | accountingApi.ts:207 `fetchJournalEntries` | `covered` |
| 148 | `admin/accounting/cost-posting-failures/` | `views_accounting.admin_cost_posting_failures` | `admin-cost-posting-failures` | accountingApi.ts:316 `fetchCostPostingFailures` | `covered` |
| 149 | `admin/accounting/trial-balance/snapshots/` | `views_accounting.admin_trial_balance_snapshot_create` | `admin-trial-balance-snapshot-create` | accountingApi.ts:130 `freezeTrialBalance` | `covered` |
| 150 | `admin/accounting/trial-balance/snapshots/list/` | `views_accounting.admin_trial_balance_snapshot_list` | `admin-trial-balance-snapshot-list` | accountingApi.ts:148 `listTrialBalanceSnapshots` | `covered` |
| 151 | `admin/accounting/trial-balance/snapshots/<int:pk>/` | `views_accounting.admin_trial_balance_snapshot_retrieve` | `admin-trial-balance-snapshot-retrieve` | accountingApi.ts:156 `fetchTrialBalanceSnapshot` | `covered` |
| 152 | `admin/accounting/gl-accounts/` | `views_accounting.admin_gl_account_list` | `admin-gl-account-list` | accountingApi.ts:349 `fetchGLAccounts` | `covered` |
| 153 | `admin/accounting/journal-entry-templates/` | `views_accounting.admin_journal_entry_template_list_or_create` | `admin-journal-entry-template-list-or-create` | accountingApi.ts:470 `fetchJournalEntryTemplates`, accountingApi.ts:478 `createJournalEntryTemplate` | `covered` |
| 154 | `admin/accounting/journal-entry-templates/<int:pk>/` | `views_accounting.admin_journal_entry_template_detail` | `admin-journal-entry-template-detail` | accountingApi.ts:494 `updateJournalEntryTemplate`, accountingApi.ts:513 `deleteJournalEntryTemplate` | `covered` |
| 155 | `admin/accounting/journal-entry-templates/<int:pk>/restore/` | `views_accounting.admin_journal_entry_template_restore` | `admin-journal-entry-template-restore` | accountingApi.ts:532 `restoreJournalEntryTemplate` | `covered` |
| 156 | `admin/demo-store/feedback/` | `views_demo_store.admin_demo_store_feedback_create` | `admin-demo-store-feedback-create` | — | `defer-candidate-O2` |
| 157 | `admin/pilots/create/` | `views_pilot_onboarding.admin_pilot_create` | `admin-pilot-create` | api.ts:2254 `createPilotDealership` | `covered` |
| 158 | `admin/pilots/` | `views_pilot_onboarding.admin_pilot_list` | `admin-pilot-list` | api.ts:2248 `fetchPilotDealerships` | `covered` |
| 159 | `admin/pilots/<slug:slug>/checklist/advance/` | `views_pilot_onboarding.admin_pilot_checklist_advance` | `admin-pilot-checklist-advance` | api.ts:2264 `advancePilotChecklistStep` | `covered` |
| 160 | `admin/pilots/<slug:slug>/inventory/import/` | `views_pilot_onboarding.admin_pilot_inventory_import` | `admin-pilot-inventory-import` | api.ts:2273 `importPilotInventory` | `covered` |
| 161 | `admin/pilots/<slug:slug>/terminate/` | `views_pilot_onboarding.admin_pilot_terminate` | `admin-pilot-terminate` | api.ts:2283 `terminatePilotDealership` | `covered` |
