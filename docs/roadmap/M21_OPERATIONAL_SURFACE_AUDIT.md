...
| 150 | `admin/accounting/journal-entry-templates/` | `views_accounting.admin_journal_entry_template_list_or_create` | `admin-journal-entry-template-list-or-create` | accountingApi.ts:470 `fetchJournalEntryTemplates`, accountingApi.ts:478 `createJournalEntryTemplate` | `covered` |
| 151 | `admin/accounting/journal-entry-templates/<int:pk>/` | `views_accounting.admin_journal_entry_template_detail` | `admin-journal-entry-template-detail` | accountingApi.ts:494 `updateJournalEntryTemplate`, accountingApi.ts:513 `deleteJournalEntryTemplate` | `covered` |
| 152 | `admin/accounting/journal-entry-templates/<int:pk>/restore/` | `views_accounting.admin_journal_entry_template_restore` | `admin-journal-entry-template-restore` | accountingApi.ts:532 `restoreJournalEntryTemplate` | `covered` |
